...
class ColorPickerAdapter internal constructor(
    ...
    private lateinit var onColorPickerListener: OnColorPickerClickListener
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener{
                onColorPickerListener.onColorPickerClickListener(
    ...
    fun setOnColorPickerClickListener(onColorPickerClickListener: OnColorPickerClickListener) {
        this.onColorPickerListener = onColorPickerClickListener
    }
